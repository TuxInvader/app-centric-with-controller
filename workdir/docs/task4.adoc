...
----
ubuntu@gateway:~/source/whatcheese-web$ git config --global user.email me@myworkshop.nginx
ubuntu@gateway:~/source/whatcheese-web$ git config --global user.name Chuck Norris
ubuntu@gateway:~/source/whatcheese-web$
ubuntu@gateway:~/source/whatcheese-web$ git add conf/nginx.conf
ubuntu@gateway:~/source/whatcheese-web$ git commit -m "fix hostname"
ubuntu@gateway:~/source/whatcheese-web$ git push
----
